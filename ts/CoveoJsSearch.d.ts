...
declare module Coveo {
	...
	function l(str: "ResultCount", param0: string): any;
...
declare module Coveo {
	...
	class HistoryController extends RootComponent implements IHistoryManager {
	    ...
	    queryStateModel: QueryStateModel;
	    queryController: QueryController;
	    usageAnalytics: IAnalyticsClient | any;
	    static ID: string;
	     ...
	     */
	    constructor(element: HTMLElement, window: Window, queryStateModel: QueryStateModel, queryController: QueryController, usageAnalytics?: IAnalyticsClient | any);
...
declare module Coveo {
	class MagicBoxClear {
	    ...
	    toggleTabindex(hasText: boolean): void;
	}
...
declare module Coveo {
	class DomUtils {
	    ...
	    static getQuickviewHeader(result: IQueryResult, options: {
	        showDate: boolean;
	        title: string;
	    }, bindings: IComponentBindings): Dom;
	}
...
declare module Coveo {
	class FacetValueStateHandler {
	    constructor(componentsFetcher: (componentId: string) => Component[]);
...
declare module Coveo {
	...
	class FacetValueSuggestions extends Component {
	    ...
	    fieldValueCache: SuggestionsCache<IFacetValueSuggestionRow[]>;
...
declare module Coveo {
	class MLFacetValueRenderer {
	    constructor(facetValue: MLFacetValue, facet: MLFacet);
	    render(): HTMLElement;
	}

}
declare module Coveo {
	interface IMLFacetValue {
	    value: string;
	    state: FacetValueState;
	    numberOfResults: number;
	}
	class MLFacetValue implements IMLFacetValue {
	    value: string;
	    state: FacetValueState;
	    numberOfResults: number;
	    constructor({value, state, numberOfResults}: IMLFacetValue, facet: MLFacet);
	     isSelected: boolean;
	     isIdle: boolean;
	    toggleSelect(): void;
	    select(): void;
	    deselect(): void;
	    equals(arg: string | MLFacetValue): boolean;
...
declare module Coveo {
	class MLFacetBreadcrumbs {
	    element: HTMLElement;
	    constructor(facet: MLFacet);
	}

}
declare module Coveo {
	interface IMLFacetHeaderButtonOptions {
	    label: string;
	...
	class MLFacetHeaderButton {
	    element: HTMLElement;
	    constructor(rootOptions: IMLFacetHeaderButtonOptions);
	    toggle(shouldDisplay: boolean): void;
	}

}
declare module Coveo {
	interface IMLFacetCollapseToggleOptions {
	    collapsed: boolean;
	}
	class MLFacetHeaderCollapseToggle {
	    element: HTMLElement;
	    constructor(facet: MLFacet);
...
declare module Coveo {
	class MLFacetValues {
	    ...
	    resetValues(): void;
	     allFacetValues: MLFacetValue[];
	     allValues: string[];
	     selectedValues: string[];
	     activeFacetValues: MLFacetValue[];
	     hasSelectedValues: boolean;
	     hasActiveValues: boolean;
	     hasIdleValues: boolean;
	    clearAll(): void;
	     isEmpty: boolean;
	    get(arg: string | MLFacetValue): MLFacetValue;
	    render(): HTMLElement;
	}

}
declare module Coveo {
	interface IMLFacetOptions extends IResponsiveComponentOptions {
	    id?: string;
	    title?: string;
	    field?: IFieldOption;
	    sortCriteria?: string;
	 ...
	 */
	class MLFacet extends Component {
	    element: HTMLElement;
	    options: IMLFacetOptions;
	    static ID: string;
	    static doExport: () => void;
	    /**
	     ...
	     */
	    constructor(element: HTMLElement, options?: IMLFacetOptions, bindings?: IComponentBindings);
	     fieldName: string;
	    /**
	    ...
	    protected initBreadCrumbEvents(): void;
	    createDom(): void;
	    triggerNewQuery(): void;
	}

}
declare module Coveo {
	class MLFacetQueryController {
	    constructor(facet: MLFacet);
